 ...
 *
 * @param func - The action function. It receives an `ActionCtx` as its first argument, and a `Request` object as its second.
 * @returns The wrapped action. Route a URL path to this function in `convex/http.js`.
 */
